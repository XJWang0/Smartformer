...
from models import Informer, Autoformer, Transformer, Linformer, Colla_Autoformer, BTDformer, \
    pshared_Autoformer, Smart_Autoformer
...
class Exp_Main(Exp_Basic):
    ...
    def _build_model(self):
        model_dict = {
            ...
            'Informer': Informer,
            'Linformer': Linformer,
            'Colla_Autoformer': Colla_Autoformer,
            'BTDformer': BTDformer,
            'param_shared': pshared_Autoformer,
            'CP_Autoformer': Smart_Autoformer,
            'SVD_Autoformer': Smart_Autoformer,
        }
