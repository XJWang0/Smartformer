...
class CP_Exp_Main(Exp_Basic):
    ...
    def train(self, setting):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                if action_iter % action_interval == 0 and action_iter > 1 and not done:
                    ...
                    if not done:
                        ...
                        next_info, next_state, real_rank, reward = change(self.model.module, action, enc, self.args.decomp_method)
                        print('-' * 100 + '\n')
        ...
        print(log)
        print(f'The rank list : {rank_list}')
        print(f'The action list : {action_list}')
