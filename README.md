...
We have set up 3 experiments, namely EEG-Transformer, Autoformer and DEformer. You can train by running the following commands. Please refer to our [paper](https://www.researchsquare.com/article/rs-1780688/v1) for the experiment results. You can view relevant project files for more parameter settings.
