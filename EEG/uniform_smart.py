...
def main(seed, random_seed=0):
    if random_seed:
        model_floder = f'./models/uniform/random_seed/'
        floder = f"./results/uniform/random_seed/"
    else:
        seed_n = seed
        set_seed(seed_n)
        model_floder = f'./models/uniform/seed_{seed}/'
        floder = f"./results/uniform/seed_{seed_n}/"
...
if __name__ == "__main__":
    ...
    main(args.seed, args.random_seed)
    unit_time(args.seed)
