...
def main(seed, random_seed=0):
    ...
    if random_seed:
        model_floder = f'./models/smartformer/random_seed/'
        floder = f"./results/smartformer/random_seed/"
    else:
        seed_n = seed
        set_seed(seed_n)
        model_floder = f'./models/smartformer/seed_{seed}/'
        floder = f"./results/smartformer/seed_{seed_n}/"
...
def unit_time(seed, random_seed=0):
    if random_seed:
        model_floder = f'./models/smartformer/random_seed/'
        floder = f"./results/smartformer/random_seed/"
    else:
    ...
    result_write = open(path, "w")
    trans = Trans(floder=floder, nsub=1, path=0)
...
if __name__ == "__main__":
    ...
    unit_time(args.seed, args.random_seed)
